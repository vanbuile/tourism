...
<?php
  require_once("../control/addTourAction.php")
?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="col m-auto">
                <form action="" method="post">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <select class="form-select" aria-label="Attraction" name="action_type">
                                <option selected value=0>Action types</option>
                                <option selected value=1>1 : khởi hành tour</option>
                                <option selected value=2>2 : kết thúc tour</option>
                                <option selected value=3>3 : ăn sáng</option>
                                <option selected value=4>4 : ăn trưa</option>
                                <option selected value=5>5 : ăn tối</option>
                                <option selected value=6>6 : checkin</option>
                                <option selected value=7>7 : checkout</option>
                            </select>
                        </div>
